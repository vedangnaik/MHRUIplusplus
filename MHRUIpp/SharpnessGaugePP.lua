...
SharpnessGaugePP = ElementPPBase:new():new("SharpnessGauge++.json", {
    x           = 5,
    y           = 80,
    w           = 70,
    borderWidth = 2,
...
SharpnessGaugePP.sharpnessColors = {
    [0] = "0xAA2C2CC9",
    [1] = "0xAA2C66C9",
    [2] = "0xAA2CD1C9",
    [3] = "0xAA2CD970",
...
function SharpnessGaugePP:draw()
...
function SharpnessGaugePP:drawConfigWindow()
